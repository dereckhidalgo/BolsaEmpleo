...
namespace ApiBolsaEmpleo.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public ActionResult Get(int id)
        {
            try
            {
                var gestor = context.Usuarios.FirstOrDefault(g => g.ID == id);
                return Ok(gestor);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public ActionResult Post([FromBody] Usuarios gestor)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public ActionResult Put(int id, [FromBody] Usuarios gestor)
        {
            try
            {
                if (gestor.ID == id)
